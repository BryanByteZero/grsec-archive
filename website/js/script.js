...
jQuery(document).ready(function($){
  ...
  //trigger tabs by data-tab attribute, for urls with hashes
  if(window.location.hash) {
    var hash = window.location.hash;
    $('[data-tab="' + hash.replace('#','') + '"]').click();
  ...
  // Hexagon content switching
  $('.hexagon-small').click(function(e){
    e.preventDefault();
    var content = $(this).attr('data-content');
    $('.hexagon-small, .hexagon-content').removeClass('current'); 
    $(this).addClass('current'); 
  ...
  // scroll to in page linked sections (and to top)
  ...
  //setup all the flickity carousels...

  $('.hexagon-content-carousel').flickity({
    wrapAround: true,
    pageDots: false,
    watchCSS: true,
    cellAlign: 'center'
  ...
  $('.testimonial-carousel').flickity({
    asNavFor: '.testimonials-top',
    cellAlign: 'center',
    wrapAround: true,
    pageDots: false,
    sync: '.testimonials-top',
  });

  $('.testimonial-carousel a').on('click', function(e){
    e.preventDefault();
    return false;
  })

  var $nc = $('.news-carousel');
  var $ncf = $nc.flickity({
    wrapAround: true,
    pageDots: false,
    watchCSS: true,
  ...
  //load additional news items if the news carousel is active
  var newsloaded = false;
  if($nc.data('flickity') && !newsloaded) {
    $.get('includes/news-snippets.php', function(newsItems) {
      $nc.flickity('append', $(newsItems));
      newsloaded = true;
    });
  }

  $ncf.on( 'select.flickity', function() {
    $nc.find('.is-visible').removeClass('is-visible');
    var adjCellElems = $nc.flickity('getAdjacentCellElements', 1);
    $( adjCellElems ).addClass('is-visible');
  });
  ...
  $hcf.on( 'select.flickity', function() {
    $hc.find('.is-visible').removeClass('is-visible');
    var adjCellElems = $hc.flickity('getAdjacentCellElements', 1);
    $( adjCellElems ).addClass('is-visible');
  });

  $hcf.trigger('select.flickity');
